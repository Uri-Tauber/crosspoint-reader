...
class BaseTheme {
 public:
  ...
  virtual void drawButtonHints(const GfxRenderer& renderer, const char* btn1, const char* btn2, const char* btn3, const char* btn4);
  ...
  virtual void drawRecentBookCover(GfxRenderer& renderer, Rect rect, std::vector<RecentBookInfo> recentBooks, const int selectorIndex,
  ...
  virtual PopupCallbacks drawPopupWithProgress(GfxRenderer& renderer, std::string title);                             
};