...
class UITheme {
 ...
 public:
  ...
  static void drawButtonHints(const GfxRenderer& renderer, const char* btn1, const char* btn2, const char* btn3, const char* btn4);
  ...
  static void drawRecentBookCover(GfxRenderer& renderer, Rect rect, std::vector<RecentBookInfo> recentBooks, const int selectorIndex,
  ...
  static PopupCallbacks drawPopupWithProgress(GfxRenderer& renderer, std::string title);
};