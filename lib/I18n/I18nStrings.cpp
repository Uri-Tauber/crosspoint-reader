...
const char* const STRINGS_PO[] = {
    ...
    "\xA3"
    "o continuar",
    "ESQ/DIR: Selecionar | OK: Confirmar",
    "Como voc\xC3"
    "\xAA"
    ...
    "Contraste",
    "Completa com porcentagem",
    "Completa com barra livro",
    "Apenas barra do livro",
    "Completa com barra cap\xC3"
    "\xAD"
    "tulo",
    "Tema da interface",
    "Cl\xC3"
